          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 bg-white/10 border border-white/30 rounded-xl text-white placeholder-blue-200/60 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  placeholder="Іван"
                />
                {errors.firstName && (
                  <p className="mt-2 text-xs text-red-300 bg-red-500/20 px-2 py-1 rounded-lg">
              ...
              <div className="rounded-xl bg-red-500/20 border border-red-500/50 p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-red-200">
                    {registerError instanceof Error ? registerError.message : 'Помилка реєстрації'}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="text-center pt-4">
              ...
              >
                ...
                <span className="underline">Увійдіть</span>
              </Link>
            </div>
          </form>
        </div>
